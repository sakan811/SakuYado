...
describe('manifest', () => {
  ...
  it('should have a descriptive description', () => {
    ...
    expect(result.description).toBe('Compare hotels based on review-per-price ratio with SakuYado')
  ...
  it('should follow PWA manifest best practices', () => {
    ...
    expect(['fullscreen', 'standalone', 'minimal-ui', 'browser']).toContain(result.display)
  })
})